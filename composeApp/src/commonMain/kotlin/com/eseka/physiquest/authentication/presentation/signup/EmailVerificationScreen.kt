...
import physiquest.composeapp.generated.resources.i_have_verified_email
        ...
        Button(
            ...
            if (state.isLoading) {
                ...
                Icon(
                    ...
                    contentDescription = stringResource(Res.string.i_have_verified_email),
                    modifier = Modifier.padding(end = 8.dp)
                )
            }
            Text(stringResource(Res.string.i_have_verified_email))
        }
